...
export default function IndoorLogScreen({ navigation }: any) {
  ...
  const [style, setStyle] = useState('Flash'); // Flash, Redpoint, etc.
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TextInput 
        style={styles.input} 
        placeholder="Ex: Vertigo, 9.8 Gravity..." 
        value={gymName}
      ...
      <View style={styles.buttonContainer}>
        <Button title="Log Ascent" color="#2E7D32" onPress={() => {
          ...
          navigation.navigate('Feed'); // Volta para a página inicial
        }} />
      </View>
    </ScrollView>
  );
