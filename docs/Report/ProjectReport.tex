...
\title{
   ...
   \end{minipage}\\[20mm]
   {\huge \textbf{ClimbBeta}\\[1ex]\LARGE Integrated Platform for Managing and Sharing Climbing and Bouldering Ascents}
}
...
{\huge \textbf{ClimbBeta}\\[1ex]\LARGE Integrated Platform for Managing and Sharing Climbing and Bouldering Ascent}\\[20mm]

% \begin{tabular}{rl}
  Gonçalo Matos, n.º50453, e-mail: a50453@alunos.isel.pt, tel.: 924391660\\[10mm]
         %& \rule{75mm}{0.5pt}\\[5mm]
\rule{75mm}{0.5pt}\\[5mm]
  Rúben Duarte, n.º48951, e-mail: a48951@alunos.isel.pt, tel.: 939423507\\[10mm]
      %& \rule{75mm}{0.5pt}\\
\rule{75mm}{0.5pt}\\[5mm]
% \end{tabular}\\[10mm]

% \begin{tabular}{rl}
  Supervisores: Filipe Freitas, e-mail: filipe.freitas@isel.pt \\[10mm]
                %& \rule{75mm}{0.5pt}\\[5mm]
    \rule{75mm}{0.5pt}\\[5mm]
...
\cleardoublepage
\chapter*{Abstract}
The objective of this project is to develop ClimbBeta, a full-stack platform dedicated to the management, logging, and sharing of indoor climbing and bouldering activities. The application targets two main audiences: practitioners (climbers) and sports facility managers (climbing gyms).

% Página de resumo em Português
\cleardoublepage
\chapter*{Resumo}
O objetivo deste projeto é desenvolver ClimbBeta, uma plataforma full-stack dedicada à gestão, registo e partilha de atividades de escalada indoor e bouldering. A plataforma foi desenhada para atender a dois públicos-alvo principais: praticantes (escaladores) e gestores de infraestruturas desportivas (ginásios de escalada).
